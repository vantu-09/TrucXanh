function taoDiv(soHang, soCot, mauNen, mauVien,soHinh) {
  if(soHinh != 0){
    soHang = Math.sqrt(soHinh);
    soCot = Math.sqrt(soHinh);
  }
  ...
  for (var j = 0; j < danhSach.length; j++) {
    ...
    if(demLat == soHang * soCot){
      ...
      var diem = parseInt(localStorage.getItem("diem"));
        ...
        window.location.href = "level/congra10.html";
      }
  }
